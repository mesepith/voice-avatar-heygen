...
exports.IAMCredentialsClient = void 0;
 ...
 */
const gapicConfig = require("./i_a_m_credentials_client_config.json");
...
class IAMCredentialsClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('iam-credentials');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.iam.credentials.v1.IAMCredentials', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.iAMCredentialsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.iam.credentials.v1.IAMCredentials') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.iam.credentials.v1.IAMCredentials, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const iAMCredentialsStubMethods = ['generateAccessToken', 'generateIdToken', 'signBlob', 'signJwt'];
        for (const methodName of iAMCredentialsStubMethods) {
            const callPromise = this.iAMCredentialsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    generateIdToken(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    signBlob(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    signJwt(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.IAMCredentialsClient = IAMCredentialsClient;
//# sourceMappingURL=i_a_m_credentials_client.js.map